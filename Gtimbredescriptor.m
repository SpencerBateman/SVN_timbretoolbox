...
ROOT_DIR = '/Users/spencer/Documents/MATLAB/SVN_timbretoolbox';
addpath(ROOT_DIR);
...
config_s.xcorr_nb_coeff = 0;   % === defines the number of auto-correlation coefficients that will be sued
config_s.threshold_harmo= 0;   % === defines the threshold [0,1] below which harmonic-features are not computed
config_s.nb_harmo		= 0;   % === defines the number of harmonics that will be extracted
% ====================
